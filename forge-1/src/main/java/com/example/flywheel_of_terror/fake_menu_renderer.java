...
public class fake_menu_renderer {
   public static void renderMainMenuWarning(Status status, fake_main_menu gui, GuiGraphics graphics, Font font, int width, int height, int alpha) {
