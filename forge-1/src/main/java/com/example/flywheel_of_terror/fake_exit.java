...
public class fake_exit extends Screen {
   ...
   private static final Component RETURN_TO_GAME = Component.literal("continue");
   ...
   public fake_exit(boolean p_96308_) {
   ...
   private void createPauseMenu() {
      ...
      RowHelper gridlayout$rowhelper = gridlayout.createRowHelper(2);
      ...
      ((Button)gridlayout$rowhelper.addChild(this.openLinkButton(REPORT_BUGS, "https://aka.ms/snapshotbugs?ref=game"))).active = !SharedConstants.getCurrentVersion()
         .getDataVersion()
         .isSideSeries();
